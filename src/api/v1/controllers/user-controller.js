...
const registerUser = expressAsyncHandler(async (request, response) => {
	...
	sendSuccessResponse(response, StatusCodes.CREATED, "User registered successfully.", {
		userId: user.id,
...
const loginUser = expressAsyncHandler(async (request, response) => {
	...
	sendSuccessResponse(response, StatusCodes.OK, "User logged in successfully.", {
		userId: userDB.id,
...
const currentUser = expressAsyncHandler(async (request, response) => {
	...
	sendSuccessResponse(response, StatusCodes.OK, "Current user fetched successfully.", { user });
...
const refreshAccessToken = expressAsyncHandler(async (request, response) => {
	...
	sendSuccessResponse(response, StatusCodes.OK, "Access token refreshed successfully.", {
...
const logoutUser = expressAsyncHandler(async (request, response) => {
	...
	sendSuccessResponse(response, StatusCodes.OK, "Logged out successfully.");
